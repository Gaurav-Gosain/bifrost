...
import (
	...
	configstoreTables "github.com/Gaurav-Gosain/bifrost/framework/configstore/tables"
	"github.com/Gaurav-Gosain/bifrost/plugins/governance"
...
func (h *GovernanceHandler) RegisterRoutes(r *router.Router, middlewares ...schemas.BifrostHTTPMiddleware) {
	...
	r.GET(PrefixRoute("/api/governance/virtual-keys"), lib.ChainMiddlewares(h.getVirtualKeys, middlewares...))
	r.POST(PrefixRoute("/api/governance/virtual-keys"), lib.ChainMiddlewares(h.createVirtualKey, middlewares...))
	r.GET(PrefixRoute("/api/governance/virtual-keys/{vk_id}"), lib.ChainMiddlewares(h.getVirtualKey, middlewares...))
	r.PUT(PrefixRoute("/api/governance/virtual-keys/{vk_id}"), lib.ChainMiddlewares(h.updateVirtualKey, middlewares...))
	r.DELETE(PrefixRoute("/api/governance/virtual-keys/{vk_id}"), lib.ChainMiddlewares(h.deleteVirtualKey, middlewares...))

	// Team CRUD operations
	r.GET(PrefixRoute("/api/governance/teams"), lib.ChainMiddlewares(h.getTeams, middlewares...))
	r.POST(PrefixRoute("/api/governance/teams"), lib.ChainMiddlewares(h.createTeam, middlewares...))
	r.GET(PrefixRoute("/api/governance/teams/{team_id}"), lib.ChainMiddlewares(h.getTeam, middlewares...))
	r.PUT(PrefixRoute("/api/governance/teams/{team_id}"), lib.ChainMiddlewares(h.updateTeam, middlewares...))
	r.DELETE(PrefixRoute("/api/governance/teams/{team_id}"), lib.ChainMiddlewares(h.deleteTeam, middlewares...))

	// Customer CRUD operations
	r.GET(PrefixRoute("/api/governance/customers"), lib.ChainMiddlewares(h.getCustomers, middlewares...))
	r.POST(PrefixRoute("/api/governance/customers"), lib.ChainMiddlewares(h.createCustomer, middlewares...))
	r.GET(PrefixRoute("/api/governance/customers/{customer_id}"), lib.ChainMiddlewares(h.getCustomer, middlewares...))
	r.PUT(PrefixRoute("/api/governance/customers/{customer_id}"), lib.ChainMiddlewares(h.updateCustomer, middlewares...))
	r.DELETE(PrefixRoute("/api/governance/customers/{customer_id}"), lib.ChainMiddlewares(h.deleteCustomer, middlewares...))

	// Budget and Rate Limit GET operations
	r.GET(PrefixRoute("/api/governance/budgets"), lib.ChainMiddlewares(h.getBudgets, middlewares...))
	r.GET(PrefixRoute("/api/governance/rate-limits"), lib.ChainMiddlewares(h.getRateLimits, middlewares...))

	// Routing Rules CRUD operations
	r.GET(PrefixRoute("/api/governance/routing-rules"), lib.ChainMiddlewares(h.getRoutingRules, middlewares...))
	r.POST(PrefixRoute("/api/governance/routing-rules"), lib.ChainMiddlewares(h.createRoutingRule, middlewares...))
	r.GET(PrefixRoute("/api/governance/routing-rules/{rule_id}"), lib.ChainMiddlewares(h.getRoutingRule, middlewares...))
	r.PUT(PrefixRoute("/api/governance/routing-rules/{rule_id}"), lib.ChainMiddlewares(h.updateRoutingRule, middlewares...))
	r.DELETE(PrefixRoute("/api/governance/routing-rules/{rule_id}"), lib.ChainMiddlewares(h.deleteRoutingRule, middlewares...))

	// Model Config CRUD operations
	r.GET(PrefixRoute("/api/governance/model-configs"), lib.ChainMiddlewares(h.getModelConfigs, middlewares...))
	r.POST(PrefixRoute("/api/governance/model-configs"), lib.ChainMiddlewares(h.createModelConfig, middlewares...))
	r.GET(PrefixRoute("/api/governance/model-configs/{mc_id}"), lib.ChainMiddlewares(h.getModelConfig, middlewares...))
	r.PUT(PrefixRoute("/api/governance/model-configs/{mc_id}"), lib.ChainMiddlewares(h.updateModelConfig, middlewares...))
	r.DELETE(PrefixRoute("/api/governance/model-configs/{mc_id}"), lib.ChainMiddlewares(h.deleteModelConfig, middlewares...))

	// Provider Governance operations
	r.GET(PrefixRoute("/api/governance/providers"), lib.ChainMiddlewares(h.getProviderGovernance, middlewares...))
	r.PUT(PrefixRoute("/api/governance/providers/{provider_name}"), lib.ChainMiddlewares(h.updateProviderGovernance, middlewares...))
	r.DELETE(PrefixRoute("/api/governance/providers/{provider_name}"), lib.ChainMiddlewares(h.deleteProviderGovernance, middlewares...))
}

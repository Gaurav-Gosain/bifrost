...
func (h *CompletionHandler) RegisterRoutes(r *router.Router, middlewares ...schemas.BifrostHTTPMiddleware) {
	...
	// Model endpoints
	r.GET(PrefixRoute("/v1/models"), lib.ChainMiddlewares(h.listModels, baseMiddlewares...))

	// Completion endpoints (non-parameterized)
	r.POST(PrefixRoute("/v1/completions"), lib.ChainMiddlewares(h.textCompletion, baseMiddlewares...))
	r.POST(PrefixRoute("/v1/chat/completions"), lib.ChainMiddlewares(h.chatCompletion, baseMiddlewares...))
	r.POST(PrefixRoute("/v1/responses"), lib.ChainMiddlewares(h.responses, baseMiddlewares...))
	r.POST(PrefixRoute("/v1/embeddings"), lib.ChainMiddlewares(h.embeddings, baseMiddlewares...))
	r.POST(PrefixRoute("/v1/audio/speech"), lib.ChainMiddlewares(h.speech, baseMiddlewares...))
	r.POST(PrefixRoute("/v1/audio/transcriptions"), lib.ChainMiddlewares(h.transcription, baseMiddlewares...))
	r.POST(PrefixRoute("/v1/images/generations"), lib.ChainMiddlewares(h.imageGeneration, baseMiddlewares...))
	r.POST(PrefixRoute("/v1/count_tokens"), lib.ChainMiddlewares(h.countTokens, baseMiddlewares...))
	r.POST(PrefixRoute("/v1/images/edits"), lib.ChainMiddlewares(h.imageEdit, baseMiddlewares...))
	r.POST(PrefixRoute("/v1/images/variations"), lib.ChainMiddlewares(h.imageVariation, baseMiddlewares...))
	...
	r.POST(PrefixRoute("/v1/batches"), lib.ChainMiddlewares(h.batchCreate, batchCreateMW...))
	r.GET(PrefixRoute("/v1/batches"), lib.ChainMiddlewares(h.batchList, batchListMW...))
	r.GET(PrefixRoute("/v1/batches/{batch_id}"), lib.ChainMiddlewares(h.batchRetrieve, batchRetrieveMW...))
	r.POST(PrefixRoute("/v1/batches/{batch_id}/cancel"), lib.ChainMiddlewares(h.batchCancel, batchCancelMW...))
	r.GET(PrefixRoute("/v1/batches/{batch_id}/results"), lib.ChainMiddlewares(h.batchResults, batchResultsMW...))
	...
	r.POST(PrefixRoute("/v1/files"), lib.ChainMiddlewares(h.fileUpload, fileUploadMW...))
	r.GET(PrefixRoute("/v1/files"), lib.ChainMiddlewares(h.fileList, fileListMW...))
	r.GET(PrefixRoute("/v1/files/{file_id}"), lib.ChainMiddlewares(h.fileRetrieve, fileRetrieveMW...))
	r.DELETE(PrefixRoute("/v1/files/{file_id}"), lib.ChainMiddlewares(h.fileDelete, fileDeleteMW...))
	r.GET(PrefixRoute("/v1/files/{file_id}/content"), lib.ChainMiddlewares(h.fileContent, fileContentMW...))
	...
	r.POST(PrefixRoute("/v1/containers"), lib.ChainMiddlewares(h.containerCreate, containerCreateMW...))
	r.GET(PrefixRoute("/v1/containers"), lib.ChainMiddlewares(h.containerList, containerListMW...))
	r.GET(PrefixRoute("/v1/containers/{container_id}"), lib.ChainMiddlewares(h.containerRetrieve, containerRetrieveMW...))
	r.DELETE(PrefixRoute("/v1/containers/{container_id}"), lib.ChainMiddlewares(h.containerDelete, containerDeleteMW...))
	...
	r.POST(PrefixRoute("/v1/containers/{container_id}/files"), lib.ChainMiddlewares(h.containerFileCreate, containerFileCreateMW...))
	r.GET(PrefixRoute("/v1/containers/{container_id}/files"), lib.ChainMiddlewares(h.containerFileList, containerFileListMW...))
	r.GET(PrefixRoute("/v1/containers/{container_id}/files/{file_id}"), lib.ChainMiddlewares(h.containerFileRetrieve, containerFileRetrieveMW...))
	r.GET(PrefixRoute("/v1/containers/{container_id}/files/{file_id}/content"), lib.ChainMiddlewares(h.containerFileContent, containerFileContentMW...))
	r.DELETE(PrefixRoute("/v1/containers/{container_id}/files/{file_id}"), lib.ChainMiddlewares(h.containerFileDelete, containerFileDeleteMW...))
}

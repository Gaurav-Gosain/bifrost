...
import (
	...
	"github.com/Gaurav-Gosain/bifrost/core/network"
	"github.com/Gaurav-Gosain/bifrost/core/schemas"
	"github.com/Gaurav-Gosain/bifrost/framework"
	...
	"github.com/Gaurav-Gosain/bifrost/framework/encrypt"
	"github.com/Gaurav-Gosain/bifrost/framework/modelcatalog"
	"github.com/Gaurav-Gosain/bifrost/plugins/litellmcompat"
...
func (h *ConfigHandler) RegisterRoutes(r *router.Router, middlewares ...schemas.BifrostHTTPMiddleware) {
	r.GET(PrefixRoute("/api/config"), lib.ChainMiddlewares(h.getConfig, middlewares...))
	r.PUT(PrefixRoute("/api/config"), lib.ChainMiddlewares(h.updateConfig, middlewares...))
	r.GET(PrefixRoute("/api/version"), lib.ChainMiddlewares(h.getVersion, middlewares...))
	r.GET(PrefixRoute("/api/proxy-config"), lib.ChainMiddlewares(h.getProxyConfig, middlewares...))
	r.PUT(PrefixRoute("/api/proxy-config"), lib.ChainMiddlewares(h.updateProxyConfig, middlewares...))
	r.POST(PrefixRoute("/api/pricing/force-sync"), lib.ChainMiddlewares(h.forceSyncPricing, middlewares...))
}

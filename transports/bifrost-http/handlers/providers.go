...
func (h *ProviderHandler) RegisterRoutes(r *router.Router, middlewares ...schemas.BifrostHTTPMiddleware) {
	...
	r.GET(PrefixRoute("/api/providers"), lib.ChainMiddlewares(h.listProviders, middlewares...))
	r.GET(PrefixRoute("/api/providers/{provider}"), lib.ChainMiddlewares(h.getProvider, middlewares...))
	r.POST(PrefixRoute("/api/providers"), lib.ChainMiddlewares(h.addProvider, middlewares...))
	r.PUT(PrefixRoute("/api/providers/{provider}"), lib.ChainMiddlewares(h.updateProvider, middlewares...))
	r.DELETE(PrefixRoute("/api/providers/{provider}"), lib.ChainMiddlewares(h.deleteProvider, middlewares...))
	r.GET(PrefixRoute("/api/keys"), lib.ChainMiddlewares(h.listKeys, middlewares...))
	r.GET(PrefixRoute("/api/models"), lib.ChainMiddlewares(h.listModels, middlewares...))
}

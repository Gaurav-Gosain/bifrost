...
import (
	...
	"github.com/Gaurav-Gosain/bifrost/framework/logstore"
	"github.com/Gaurav-Gosain/bifrost/plugins/logging"
...
func (h *LoggingHandler) RegisterRoutes(r *router.Router, middlewares ...schemas.BifrostHTTPMiddleware) {
	...
	r.GET(PrefixRoute("/api/logs"), lib.ChainMiddlewares(h.getLogs, middlewares...))
	r.GET(PrefixRoute("/api/logs/stats"), lib.ChainMiddlewares(h.getLogsStats, middlewares...))
	r.GET(PrefixRoute("/api/logs/histogram"), lib.ChainMiddlewares(h.getLogsHistogram, middlewares...))
	r.GET(PrefixRoute("/api/logs/histogram/tokens"), lib.ChainMiddlewares(h.getLogsTokenHistogram, middlewares...))
	r.GET(PrefixRoute("/api/logs/histogram/cost"), lib.ChainMiddlewares(h.getLogsCostHistogram, middlewares...))
	r.GET(PrefixRoute("/api/logs/histogram/models"), lib.ChainMiddlewares(h.getLogsModelHistogram, middlewares...))
	r.GET(PrefixRoute("/api/logs/dropped"), lib.ChainMiddlewares(h.getDroppedRequests, middlewares...))
	r.GET(PrefixRoute("/api/logs/filterdata"), lib.ChainMiddlewares(h.getAvailableFilterData, middlewares...))
	r.DELETE(PrefixRoute("/api/logs"), lib.ChainMiddlewares(h.deleteLogs, middlewares...))
	r.POST(PrefixRoute("/api/logs/recalculate-cost"), lib.ChainMiddlewares(h.recalculateLogCosts, middlewares...))

	// MCP Tool Log retrieval with filtering, search, and pagination
	r.GET(PrefixRoute("/api/mcp-logs"), lib.ChainMiddlewares(h.getMCPLogs, middlewares...))
	r.GET(PrefixRoute("/api/mcp-logs/stats"), lib.ChainMiddlewares(h.getMCPLogsStats, middlewares...))
	r.GET(PrefixRoute("/api/mcp-logs/filterdata"), lib.ChainMiddlewares(h.getMCPLogsFilterData, middlewares...))
	r.DELETE(PrefixRoute("/api/mcp-logs"), lib.ChainMiddlewares(h.deleteMCPLogs, middlewares...))
}

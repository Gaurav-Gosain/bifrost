...
func (g *GenericRouter) RegisterRoutes(r *router.Router, middlewares ...schemas.BifrostHTTPMiddleware) {
	for _, route := range g.routes {
		...
		routePath := PrefixRoute(route.Path)
		switch method {
		case fasthttp.MethodPost:
			r.POST(routePath, lib.ChainMiddlewares(handler, routeMiddlewares...))
		case fasthttp.MethodGet:
			r.GET(routePath, lib.ChainMiddlewares(handler, routeMiddlewares...))
		case fasthttp.MethodPut:
			r.PUT(routePath, lib.ChainMiddlewares(handler, routeMiddlewares...))
		case fasthttp.MethodDelete:
			r.DELETE(routePath, lib.ChainMiddlewares(handler, routeMiddlewares...))
		case fasthttp.MethodHead:
			r.HEAD(routePath, lib.ChainMiddlewares(handler, routeMiddlewares...))
		default:
			r.POST(routePath, lib.ChainMiddlewares(handler, routeMiddlewares...))
		}
	}

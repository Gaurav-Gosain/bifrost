module github.com/Gaurav-Gosain/bifrost/plugins/semanticcache
...
require (
	...
	github.com/Gaurav-Gosain/bifrost/core v1.4.0
	github.com/Gaurav-Gosain/bifrost/framework v1.2.17
	github.com/Gaurav-Gosain/bifrost/plugins/mocker v1.4.17
)

module github.com/Gaurav-Gosain/bifrost/tests/scripts/1millogs

go 1.25.5

require (
	github.com/Gaurav-Gosain/bifrost/core v1.2.37
	github.com/Gaurav-Gosain/bifrost/framework v0.0.0
